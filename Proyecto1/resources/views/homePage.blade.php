...
@section('content')
    ...
    <div class="container mx-auto p-4">
                ...
                <div class="gridCards">
                    @foreach ($proyectosRecientes as $proyecto)
                        <x-cardItemReciente titulo="{{ $proyecto['titulo'] }}" descripcion="{{ $proyecto['descripcion'] }}"
                            :project="$proyecto" :data-projecte="$proyecto" />
                    @endforeach
                </div>
            @endif
        </div>
                ...
                <div class="gridCards margenElementsGridTareas">
                    @foreach($tareasAsignadas as $tarea)
                        <x-listItemTarea titulo="{{ $tarea['titulo'] }}" descripcion="{{ $tarea['descripcion'] }}"
                            id="{{ $tarea['id'] }}" :tag="$tarea['tags']" :data-tarea="$tarea"
            ...
            @else
                <div class="gridCardsProyectos">
                    @foreach ($proyectosTotal as $proyectoT)
                        <x-cardItemProyectos class="cardProyectoId" titulo="{{ $proyectoT['titulo'] }}"
                            descripcion="{{ $proyectoT['descripcion'] }}" estado="{{ $proyectoT['estadoId'] }}"
                            fechaEntrega="{{ $proyectoT['fechaEntrega'] }}" :data-proyecto="$proyectoT" :project="$proyectoT" />
                    @endforeach
                </div>
            @endif
        </div>
        ...
        <div class="alturaFija oculto" id="contenedorProyectoEspecifico">
            <div class="card-contenedor"
                style="height: 100%; display: flex; flex-wrap: wrap; justify-content: space-between; cursor: auto;">
                <div
                    style="height: 100%; width: 96%; display: flex; flex-direction: column; justify-content: flex-start; padding: 2%;">
                    <h2 id="tituloProyecto" class="text-xl font-bold mb-2" style="height: fit-content; width: fit-content;">
                        Proyecto x</h2>
                    ...
                    <div style="width: 100%; height: 35%; margin-left: 1%; border-bottom: 3px solid green">
                        <div style="width: auto; display: flex; flex-wrap: wrap;" class="texto-cortado">
                            <div style="width: 50%; height: auto; display: flex; align-items: flex-start;">
                                <h3 class="text-l font-bold mb-2 texto-cortado"
                                    style="white-space: normal; overflow-wrap: break-word; word-break: break-all; margin: 0">
                                    Descripción</h3>
                            </div>
                            <div id="tagsCompartidos"
                                style="width: 50%; height: 100%; display: flex; justify-content: flex-end;">
                        ...
                        <div style="white-space: normal; overflow-wrap: break-word; word-break: break-all; margin: 0; height: 100px;"
                    ...
                    <div
                        style="width: 100%; height: auto; display: flex; align-items: flex-start; margin-left: 1%; overflow: hidden; margin-top: 10px;">
                        <h3 class="text-l font-bold mb-2 texto-cortado"
                            style="white-space: normal; overflow-wrap: break-word; word-break: break-all; margin: 0">Link
                            del proyecto: </h3>
                        <a id="linkOut" href="">
                            <p id="link"
                                style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-left: 3px; flex: 1;">
                                X</p>
                        </a>
                    </div>

                    <div
                        style="width: 99%; height: auto; display: flex; align-items: center; justify-content: space-around; margin-left: 2%; margin-top: 10px;">
                        <div>
                    ...
                    <div
                        style="width: 99%; height: auto; display: flex; align-items: center; justify-content: space-between; margin-left: 2%; margin-top: 10px;">
                        ...
                        <div style="width: 90%; height: 20px; display: flex; justify-content: flex-end;">
                            <h3 id="numeroTareas" class="text-l font-bold mb-2 texto-cortado" style="width: fit-content;">
                                NUMBER OF TASKS: X</h3>
                            <img id="plus" src="../storage/assets/icons/plus.png" alt=""
                                style="width: fit-content; height: 20px; cursor: pointer; margin-left: 5%;">
                            <img id="less" src="../storage/assets/icons/menos.png" class="oculto" alt=""
                                style="width: fit-content; height: 20px; cursor: pointer; margin-left: 5%;">
                        </div>
                    </div>

                    <div id="contenedorTareasProyecto" class="contenedorScroll"
                        style="width: 99%; height: 120px; margin-left: 2%; margin-top: 10px; display: flex; flex-direction: column; gap: 5px;">
                        @foreach($tareasAsignadas as $tarea)
                            <x-cardItemReciente titulo="{{ $tarea['titulo'] }}" type="1" />
                        @endforeach
                    </div>

                </div>
                <div id="cerrarContenedor"
                    style="height: 100%; width: 3%; display: flex; justify-content: center; padding-top: 0.5%; border-radius: 0 0.75rem 0.75rem 0;">
                    <img id="imagen" src="../storage/assets/icons/cerrar.png" alt=""
                        style="width: 85%; height: fit-content; cursor: pointer;">
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal para ver tarea (ELIMINADO - Ahora redirige al proyecto) -->
