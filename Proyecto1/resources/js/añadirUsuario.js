/**
 * Gestor de selección de usuarios para proyectos/grupos.
 * 
 * Proporciona funcionalidad para:
 * - Mostrar/ocultar lista de usuarios con botón de añadir
 * - Buscar/filtrar usuarios en tiempo real
 * - Añadir usuarios/grupos a la lista de seleccionados
 * - Mostrar tipo de usuario (Super Usuario, Usuario normal)
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    userItems.forEach(item => {
        item.addEventListener('click', function () {
            ...
            // Determinar el tipo de usuario según el ID
            switch (userType) {
                case "1":
    ...
    /**
     * Ocultar lista al hacer clic fuera del dropdown.
     */
