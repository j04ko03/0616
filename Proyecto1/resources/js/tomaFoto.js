...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (takePhotoBtn && video && canvas) {
        takePhotoBtn.addEventListener('click', () => {
            ...
            if (previewContainer) previewContainer.innerHTML = `<img src="${dataUrl}" alt="Foto de usuario">`;
        ...
        uploadFile.addEventListener('change', (e) => {
            ...
            if (file && (file.type === "image/png" || file.type === "image/jpeg" || file.type === "image/jpg")) {
                ...
                reader.onload = function (evt) {
                    if (previewContainer) previewContainer.innerHTML = `<img src="${evt.target.result}" alt="Foto subida">`;
                    if (modal) modal.style.display = 'none';
    ...
    function subirImagenAlServidor(dataUrl) {
        if (typeof RUTA_SUBIR_FOTO === 'undefined') {
            console.error("RUTA_SUBIR_FOTO no definida.");
            return;
        }
